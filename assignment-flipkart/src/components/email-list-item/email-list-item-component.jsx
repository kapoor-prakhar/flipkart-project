...
const EmailListItem = ({ sender, fromEmail, subject, snippet, timestamp, isAddedToFavorite, onClickItem, isRead }) => {
  const senderInitial = sender ? sender[0].toUpperCase() : '';

  return (
    <div className="email-card" onClick={onClickItem} style={{background: isRead ? '#fff' : '#f4f5f9'}}>
